...
alias upload_aws_s3_sync_taxonline_assets='AWS_PROFILE=myobad aws s3 sync --sse aws:kms --sse-kms-key-id=5db5f6c9-b5ee-4479-8a33-45311162b30c . s3://taxonline-assets/'
alias download_aws_s3_sync_taxonline_assets='AWS_PROFILE=myobad aws s3 sync --sse aws:kms --sse-kms-key-id=5db5f6c9-b5ee-4479-8a33-45311162b30c s3://taxonline-assets/ .'
