...
alias upload_taxonline_ci='(login_aws_myobad_apse2 && cd ~/Myob/aws-s3/taxonline-ci && upload_aws_s3_sync_taxonline_ci)'
alias download_taxonline_ci='(login_aws_myobad_apse2 && cd ~/Myob/aws-s3/taxonline-ci && download_aws_s3_sync_taxonline_ci)'
